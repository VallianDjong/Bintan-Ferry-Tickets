...
/* Hero Container */
        .detail-hero {
            ...
            width: 100%;
            min-height: 480px;
            /* Placeholder image matching your family-on-boat theme */
            background: url('https://images.unsplash.com/photo-1519167758481-83f550bb49b3?q=80&w=2000') no-repeat center center;
            background-size: cover;
            border-radius: 20px;
            overflow: hidden;
            display: flex;
        ...
        .detail-hero::before {
            ...
            width: 100%;
            height: 100%;
            background: rgba(15, 32, 54, 0.65); /* Dark blue-tinted overlay */
            z-index: 1;
        }
        ...
        .detail-hero-content {
            ...
            z-index: 2;
            color: white;
            padding-left: 10%; /* Matches the left-heavy alignment in the image */
            max-width: 100%;
        }
        ...
        /* Responsive */
        @media (max-width: 992px) {
            .detail-hero-content { padding-left: 5%; padding-right: 5%; }
...
.content-section {
        ...
        /* Highlight for the phone number */
        .contact-highlight {
            color: #0f172a;
            font-weight: 500;
        }
        ...
        .social-icons a {
            color: #ef534e; /* Matching your theme red */
            font-size: 1.2rem;
            transition: 0.2s;
        }
        ...
        .hero-title span {
            color: #ef534e; /* Accent color from your images */
        }
...
<div class="hero-section">
        <span class="category-label">Travel Information</span>
        <h1 class="hero-title">
            Batam Ferry E-Boarding Pass: <br>
            <span>A Simple, Stress-Free Travel</span> Experience
        </h1>
        <p class="hero-subtitle">
            Batam Ferry's e-boarding pass streamlines travel between Singapore and Batam, 
            offering a quicker, paperless boarding experience with a unique QR code after passport verification.
        </p>
    </div>

    <div class="content-container">
        <div class="meta-info">
            <span><i class="far fa-calendar-alt"></i> April 3, 2026</span>
            <span><i class="far fa-clock"></i> 5 minutes read</span>
        </div>

        <p class="intro-text">
            Traveling to Batam has never been easier with the latest digital integration. 
            The introduction of the e-boarding pass system allows passengers to bypass traditional 
            ticket queues and enjoy a seamless journey from terminal to ferry. 
            In this guide, we explore how this technology is transforming regional travel 
            and making your weekend getaways much more efficient.
        </p>

        <img src="tes-ferry-5.jpg" 
             alt="Batam Fast Ferry" class="post-image">
    </div>

<?php
// Content Data
$section1_title = "What Is The E-Boarding Pass?";
$section1_desc = "The e-boarding pass is a digital version of your ferry ticket. After booking your ferry ticket online, you will receive an e-boarding pass with your unique QR code—provided you've completed the passport verification process. Once verified, the e-boarding pass will be sent to your email. For Singapore to Batam travel, print the boarding pass at home. If you're traveling from Batam to Singapore, simply scan your digital pass directly from your phone.";

$section2_title = "How Does It Work?";
$steps = [
    [
        "title" => "1. Book and Verify:",
        "text" => "After booking your ferry ticket online, first-time travelers or passengers with a new passport must complete a one-time passport verification. This can be done by showing your passport at the ticket counter or via WhatsApp at <span class='contact-highlight'>+65 9158 1013</span>."
    ],
    [
        "title" => "2. Receive Your E-Boarding Pass:",
        "text" => "Once your passport is verified, you will receive your e-boarding pass with a unique QR code via email."
    ],
    [
        "title" => "3. Print Your Boarding Pass:",
        "text" => "If you're traveling from Singapore to Batam, print your boarding pass before heading to the terminal."
    ],
    [
        "title" => "4. Board the Ferry:",
        "text" => "At the terminal, scan your e-boarding pass with your unique QR code on your phone (for Batam to Singapore travel) or your printed pass (for Singapore to Batam). If you're using your phone, make sure to brighten the screen to ensure an easy scan."
    ]
];
?>
...
<div class="container content-section">
    ...
    <h2>Benefits Of The E-Boarding Pass</h2>

    <ul class="benefits-list">
        <li>
            <span class="benefit-title">Quick and Convenient:</span> 
            Each passenger gets their own QR code, making it easy to board without waiting for paper tickets. Simply use your phone or print your boarding pass at home.
        </li>
        <li>
            <span class="benefit-title">Faster Boarding:</span> 
            The QR code scan speeds up the boarding process, helping you get on the ferry faster.
        </li>
        <li>
            <span class="benefit-title">Eco-Friendly:</span> 
            The e-boarding pass is paperless, helping reduce waste.
        </li>
        <li>
            <span class="benefit-title">Easy to Access:</span> 
            Since the e-boarding pass is digital, you won't have to worry about losing your boarding pass. Just pull it up on your phone when it's time to board.
        </li>
    </ul>

    <p class="summary-text">
        The e-boarding pass from Horizon Fast Ferry makes travel between Singapore and Batam more efficient, especially for those who may travel multiple times with the same passport. After completing your one-time passport verification, you'll receive a unique QR code for each journey, simplifying the boarding process every time. Skip the paper tickets, reduce your wait time, and enjoy a quicker, smoother journey. Book your ferry tickets today and experience hassle-free travel with the e-boarding pass.
    </p>

    <div class="article-footer">
        <div class="tag-buttons">
            <a href="#" class="btn-tag">E-Boarding Pass</a>
            <a href="#" class="btn-tag">Harbour Bay Ferry Terminal</a>
        </div>

        <div class="share-box">
            <span class="share-text">Share this with your travel buddies!</span>
...
$related_posts = [
    [
        ...
        "date" => "April 3, 2026",
        "title" => "Ferry Travel Guide to Batam",
        "excerpt" => "Learn everything about ferry travel, booking tips, boarding process, and what to expect during your journey."
    ],
    [
        "image" => "visa.jpg",
        "date" => "April 3, 2026",
        "title" => "Visa & Entry Requirements",
        "excerpt" => "Understand visa rules, passport validity, and entry requirements for smooth and hassle-free travel to Batam."
    ],
    [
        "image" => "hero img.png",
        "date" => "April 3, 2026",
        "title" => "Ferry Schedule Tips",
        "excerpt" => "Get helpful tips on choosing ferry timings, avoiding peak hours, and planning your travel schedule efficiently."
    ]
];
?>
...
<div class="vtl-support-banner shadow-sm">
    ...
    <div class="vtl-banner-content text-end">
        <div class="vtl-support-text d-inline-block text-start">
            <h2 class="vtl-banner-title" style="color:white;">24/7 Customer Support</h2>
...
<div class="vtl-separator"></div>
            <div class="vtl-bottom-line">
                ...
                Batam Ferry Tickets Is Part of VTL Travel Private Limited
                </div>
